const derkenarData = {
    "intro": [
        {
            "content": `Eskilerin tabiriyle 'derkenar'; bir metnin sayfa boşluklarına, kenarına köşesine düşülen not demektir. Çoğu zaman ana metnin ciddiyetine sığmayan, yazanı o an heyecanlandıran veya bir düşünceyi şerh eden bu küçük kayıtlar, aslında zihnin en özgür olduğu alanlardır.

Zihin, sadece kürsülerde veya kalın kitapların arasında işlemez; bazen bir fıkrada, bazen hararetli bir tartışmanın en kısa cümlesinde, bazen de bir kentin en tenha duvarında kendini gösterir. Burada; profesyonel bir çalışmanın sınırlarına sığmayan, hayatın akışından süzülüp zihnimde yer edinen 'parçalı' düşünceleri ve anlık kayıtları paylaşıyorum.

Bu sayfa, hayatın ana metnine düşülmüş mütevazı bir şerh, akademik disiplinin dışına taşan bir nefeslenme alanıdır.`
        }
    ],
    "konular": [
    {
...
En son hocaların en şöhretlisini davet etmişler.
Bir duada yağmur yağdırıyor.
Yağmur duasının da şartları varmış.
Mesela safların içine hocadan şüphe duyan girmeyecek.
İkincisi de abdestsiz kimse olmayacak.
Neyse bu şöhretli hoca da gelmiş.
...
Eskiden evinde doğalgazı olan herkese hava atardı
Bugün közde çay bulan fotoğrafını çekip instagrama atıyor
